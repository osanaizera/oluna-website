  ...
  return (
    <html lang="pt-BR" className={fontVariables}>
      <head>
        ...
        {/* Feed Links */}
        <link rel="alternate" type="application/rss+xml" title="Ôluna Engenharia - Blog RSS" href="/feed.xml" />
        <link rel="alternate" type="application/atom+xml" title="Ôluna Engenharia - Blog Atom" href="/atom.xml" />
