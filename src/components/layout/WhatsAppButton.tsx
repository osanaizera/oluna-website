      ...
      {isVisible && (
        ...
        >
          <div className="relative">
            ...
            {/* Container do botão com espaço para badge */}
            <div className="relative">
              {/* Enhanced notification badge - FORA do botão */}
              <motion.div
              ...
              >
                ...
                <div className="absolute inset-0 bg-red-300 rounded-full animate-ping opacity-20" style={{ animationDelay: '0.5s' }}></div>
              </motion.div>
