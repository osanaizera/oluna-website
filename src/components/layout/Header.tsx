          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center">
              <motion.button
                type="button"
                onClick={() => {
                  const message = encodeURIComponent('Olá! Gostaria de falar com um especialista da Ôluna Engenharia.')
                  window.open(`https://wa.me/5521973498376?text=${message}`, '_blank')
                }}
                className="bg-gradient-to-r from-green-500 to-green-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 flex items-center gap-2"
