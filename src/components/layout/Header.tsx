        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center">
              <motion.a
                href="https://wa.me/5521973498376?text=Ol%C3%A1!%20Gostaria%20de%20falar%20com%20um%20especialista%20da%20%C3%94luna%20Engenharia."
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-green-500 to-green-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 flex items-center gap-2 inline-flex"
