      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" viewBox="0 0 1200 400" preserveAspectRatio="none">
            ...
            <path d="M0,50 Q300,20 600,50 T1200,50 L1200,150 Q900,120 600,150 T0,150 Z" 
                  fill="url(#footerThermal1)" 
                  filter="url(#footerGlow)"
                  className="animate-pulse"
                  style={{ animationDuration: '10s' }} />
            
            <path d="M0,250 Q400,220 800,250 T1200,250 L1200,400 L0,400 Z" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="w-10 h-10 bg-gradient-to-br from-primary-400 to-accent-500 rounded-xl flex items-center justify-center mr-3 relative overflow-hidden group">
                ...
                <div className="absolute inset-0 opacity-20">
                  <svg className="w-full h-full" viewBox="0 0 40 40">
                    ...
                    <circle cx="20" cy="20" r="15" fill="url(#footerLogoThermal)" 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="#servicos" className="hover:text-primary-400 transition-all duration-300 relative group block py-1">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">contato@olunaengenharia.com.br</span>
              </div>
            ...
            {/* CTA WhatsApp */}
            <button className="mt-6 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-300 flex items-center gap-2 relative overflow-hidden group hover:scale-105 hover:shadow-lg">
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
            <p>
              © {currentYear} Ôluna Engenharia. Todos os direitos reservados.
            </p>
