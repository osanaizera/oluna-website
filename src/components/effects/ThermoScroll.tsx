  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 transition-all duration-2000 ease-out ${
        ...
        <div className={`absolute inset-0 transition-all duration-2500 ease-out delay-500 ${
      ...
      <div className={`absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-transparent via-primary-400 to-transparent 
...
// Componente específico para imagens de painéis elétricos
...
export function ThermoImage({ src, alt, className = '', delay = 0 }: ThermoImageProps) {
  return (
