...
const services = [
  {
    ...
    description: 'Inspeção termográfica para identificar pontos quentes, sobrecargas e conexões soltas em painéis elétricos, CCMs e barramentos.',
  ...
  },
  {
    ...
    description: 'Análise completa da qualidade de energia, medição de harmônicas, fator de potência e identificação de oportunidades de economia.',
  ...
  },
  {
    ...
    description: 'Elaboração de laudos técnicos assinados por engenheiro CRE A para atender as normas NR-10 e NR-12.',
  ...
  },
  {
    ...
    description: 'Sistema de monitoramento 24/7 com alertas automáticos por e-mail, WhatsApp e dashboard web para acompanhamento.',
    icon: MonitoringIcon,
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Soluções especializadas em engenharia elétrica e termografia para 
            garantir a segurança e eficiência da sua operação.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* CTA */}
              <button className={`w-full py-3 rounded-xl font-semibold text-white transition-all duration-300 bg-gradient-to-r ${service.gradient} hover:shadow-lg hover:scale-105`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-gray-600 mb-6">
                  Não encontrou exatamente o que precisa? Nossa equipe desenvolve 
                  soluções personalizadas para seu desafio específico.
                </p>
