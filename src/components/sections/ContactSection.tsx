      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-8">
          <svg className="w-full h-full" viewBox="0 0 1200 600" preserveAspectRatio="none">
            ...
            <path d="M0,100 Q300,50 600,100 T1200,100 Q900,150 600,200 T0,200 Z" 
                  fill="url(#contactThermal1)" 
                  filter="url(#contactGlow)"
                  className="animate-pulse"
                  style={{ animationDuration: '12s' }} />
            
            <path d="M0,400 Q400,350 800,400 T1200,400 L1200,600 L0,600 Z" 
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Contato direto e agendamento rápido
                  </p>
